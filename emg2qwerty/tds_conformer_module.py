...
class TDSConformerCTCModule(pl.LightningModule):
    ...
    def __init__(
        ...
        if frontend_features != input_dim:
            self.input_proj = nn.Linear(frontend_features, input_dim)
        else:
        ...
        self.classifier = nn.Sequential(
            nn.Linear(input_dim, charset().num_classes),
            nn.LogSoftmax(dim=-1),
        )
    ...
    def forward(
        ...
        t_out = x.shape[1]
        t_diff = t_in - t_out
        output_lengths = input_lengths - t_diff
